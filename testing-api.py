...
WEBHOOK_URL = "https://ezzecore1.mobi:8443/qrjump-bot"
PORT = 88
...
async def keypad(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    result = fetch_language(telegram_id)    
    keyboard = [[InlineKeyboardButton("NEXT", web_app=WebAppInfo(url=f"https://f748-110-235-223-133.ngrok-free.app/?version=v1.1&telegram_id={telegram_id}&telegram_username={telegram_username}"))]]
